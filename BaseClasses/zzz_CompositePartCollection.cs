...
{
    //[Serializable]
    //public class zzz_CompositePartCollection
    //{
    //    [XmlElement("CompositePart")]
    //    public List<zzz_CompositePart> CompositePartList { get; set; }

    //    public zzz_CompositePartCollection()
    //    {
    //        CompositePartList = new List<zzz_CompositePart>();
    //    }
    ...
    //    public zzz_CompositePartCollection DeserialiseFromXMLString(string XMLString)
    //    {
    //        var serializer = new XmlSerializer(this.GetType());
    //        using (TextReader reader = new StringReader(XMLString))
    //        {
    //            return (zzz_CompositePartCollection)serializer.Deserialize(reader);
    //        }
    //    }
